    ...
    <section className="flex flex-wrap items-center justify-center h-screen">
      <fieldset className="fieldset w-xl bg-base-200 border border-base-300 p-4 rounded-box">
        {user.role === "tenaga kesehatan" ? (
          <>
            <legend className="fieldset-legend">Help Diagnose Disease</legend>
            <form
              onSubmit={addDisease}
          ...
          <div className="flex align-items-center justify-center text-center flex-col gap-2">
            <legend className="text-center text-l font-bold">
              Book Consultation with Our Doctor
            </legend>
            <p>Contact +62812345678 (phone or WhatsApp)</p>
            <center>
            ...
            <br />
            <p>Or directly come to Zehat Clinic</p>
            <p className="font-bold text-l">Address:</p>
            <p>
              Jl. Sultan Iskandar Muda No.7, RT.5/RW.9, Kby. Lama Sel., Kec.
